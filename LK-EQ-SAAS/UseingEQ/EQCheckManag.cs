...
namespace UseingEQ
{
    public partial class EQCheckManag : Form, IPlug
    {
        ...
        public EQCheckManag()
        {
            ...
            this.dataGView1.Url = "LoadZhuBiaoInfoSelect_EQCheck";
            this.dataGView2.Url = "LoadXiBiaoInfoSelect_EQCheck";
        }
        ...
        private void Del_toolStrip_Click(object sender, EventArgs e)//删除
        {
            ...
            else
            {
                ...
                {
                    LData.Exe("UpdateStatus_EQCheckManag", null, new object[] { drX["检查ID"].ToString(), His.his.Choscode });
                    WJs.alert("删除成功！");
        ...
        private void View_toolStrip_Click(object sender, EventArgs e)//浏览
        {
            ...
            //浏览 全能 状态
            EQCheckManagEdit form = new EQCheckManagEdit(drZ, drX, 0);
            form.ShowDialog();
        }
        ...
        private void Edit_toolStrip_Click(object sender, EventArgs e)//编辑
        {
            ...
            //编辑  全能状态
            EQCheckManagEdit form = new EQCheckManagEdit(drZ, drX, 1);
            form.ShowDialog();
            refresh_toolStrip_Click(null, null);
        ...
        private void Add_toolStrip_Click(object sender, EventArgs e)//新增
        {
            ...
            //新增  全能  状态
            EQCheckManagEdit form = new EQCheckManagEdit(drZ, null, 2);//以新增进去
            form.ShowDialog();
            refresh_toolStrip_Click(null, null);
        }
        ...
        private void EQCheckManag_Load(object sender, EventArgs e)//窗体加载
        {
