...
{
    public partial class EQOut : Form, IPlug
    {
        ...
        private void add_toolStripButton_Click(object sender, EventArgs e)
        {
            ...
            EQOut_Add form = new EQOut_Add(this.InWare_selTextInpt.Value, this.InWare_selTextInpt.Text,app);
        ...
        private void scan_toolStripButton_Click(object sender, EventArgs e)
        {
            ...
            if (dr != null)
            {
                EQOut_Add form = new EQOut_Add(dr, 3,app);//浏览
                form.ShowDialog();
       ...
       public  void Reload(int a)//删除成功返回事件
          ...
          //  List<Dictionary<string, ObjItem>> list = this.dataGView2.GetData();
            if (dr != null)
            {
                ...
                if (dr["状态"].ToInt() == 1)
                {
                    ...
                    EQOut_Add form = new EQOut_Add(dr, 4,app);//编辑
                    form.Main = this;
                    form.ShowDialog();
        ...
        private void EQIn_Load(object sender, EventArgs e)//加载数据
        {
            ...
            WJs.SetDictTimeOut();
            this.dataGView1.Url = "EQOutMainSearch";
            ...
            this.InWare_selTextInpt.Sql = "EQGetOutWare";
            ...
            TvList.newBind().Load("EQOut_Ware", new object[] { His.his.Choscode }).Bind(this.Column4);
            TvList.newBind().Load("EQOut_IONAME", new object[] { His.his.Choscode }).Bind(this.Column2);
