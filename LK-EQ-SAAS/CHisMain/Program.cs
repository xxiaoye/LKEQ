...
namespace CHisMain
{
    static class Program
    {
        ...
        {            
            ...
            SysSet.LinkTel = "服务热线:4006613506转1   ";
            SysSet.LinkQQ  = "企业QQ：800013506";
            //SysSet.LinkTel = "";
            //SysSet.LinkQQ = "";
            ...
            SysSet.MenuName = "menuinfo";

            SysSet.SysName = "联科医院信息系统( HIS )";
            SysSet.SysPath = "联科软件";
            SysSet.MainTitle = "联科医院信息系统( HIS )";
            SysSet.UserInputLoc = new Point(25, 50);
            SysSet.NotifyShow = false;
            SysSet.LoginInc = "LKHisSer.Login";
            ...
            //状态栏新增点击按钮
            SysSet.BottomUrls.Add(new UrlLink("农合后台系统", "http://xnh.gzxnh.gov.cn/guizhou/"));
            ...
            SysSet.LoginSuc = new LoginSucHandle(delegate(LoadEvent e, string sjh, string userPwd, Sys login)
            {
                ...
                load.Action = "LKHisSer.his.sys.GetHisParam";
